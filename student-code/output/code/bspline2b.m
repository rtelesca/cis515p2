...
for i = 1:(N - 2)
    ...
    elseif i == N - 2
        ...
        Bx(i, 1) = 1/6*dx(i) + 4/6*dx(i + 1) + 1/6*dx(i + 2);
        By(i, 1) = 1/6*dy(i) + 4/6*dy(i + 1) + 1/6*dy(i + 2);
        Bx(i, 2) = 2/3*dx(i) + 1/3*dx(i + 1);
        By(i, 2) = 2/3*dy(i) + 1/3*dy(i + 1);
        Bx(i, 3) = 1/3*dx(i) + 2/3*dx(i + 1);
        By(i, 3) = 1/3*dy(i) + 2/3*dy(i + 1);
        Bx(i, 4) = 1/6*dx(i) + 4/6*dx(i + 1) + 1/6*dx(i + 2);
        By(i, 4) = 1/6*dy(i) + 4/6*dy(i + 1) + 1/6*dy(i + 2);
    end
end
